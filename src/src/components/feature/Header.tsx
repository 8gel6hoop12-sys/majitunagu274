        ...
        <div className="flex items-center justify-between">
          ...
          <a href={`${import.meta.env.BASE_URL}`} onClick={goHome} className="flex items-center space-x-3 group cursor-pointer">
            <img
              src={logoSrc}
              alt="マジツナグ"
              className="h-8 w-auto object-contain drop-shadow-sm transition-transform duration-150 group-hover:scale-[1.02]"
              loading="eager"
              decoding="async"
            />
            <span className="hidden sm:block text-xl font-bold text-gray-900" style={{ fontFamily: '"Pacifico", serif' }}>
              マジツナグ
            </span>
          </a>
